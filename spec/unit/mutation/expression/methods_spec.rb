...
RSpec.describe Mutation::Expression::Methods do
  ...
  describe '#matcher' do
    ...
    context 'with an instance method' do
      ...
      it { should eql(Mutation::Matcher::Methods::Instance.new(TestApp::Literal)) }
    end

    context 'with a singleton method' do
      let(:attributes) { { scope_name: 'TestApp::Literal', scope_symbol: '.' } }

      it { should eql(Mutation::Matcher::Methods::Singleton.new(TestApp::Literal)) }
    end
  end
end
