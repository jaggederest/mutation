...
RSpec.describe Mutation::Reporter::CLI::Printer::MutationResult do
  ...
  describe '.call' do
    context 'isolation problem' do
      ...
      let(:mutation_a_isolation_result) do
        Mutation::Isolation::Fork::ChildError.new(status)
      end
      ...
      context 'on evil mutation' do
        context 'with a diff' do
          context 'on a tty' do
            ...
            it_reports(
              [
                [Mutation::Color::NONE,  "evil:subject-a:d27d2\n"],
                [Mutation::Color::NONE,  "@@ -1,2 +1,2 @@\n"],
                [Mutation::Color::RED,   "-true\n"],
                [Mutation::Color::GREEN, "+false\n"],
                [Mutation::Color::NONE,  "-----------------------\n"]
        ...
        context 'without a diff' do
          # This is intentionally invalid AST mutation might produce
          ...
          it_reports(<<~REPORT)
            ...
            Please report a reproduction to https://github.com/mbj/mutation
