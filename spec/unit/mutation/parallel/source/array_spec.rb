...
RSpec.describe Mutation::Parallel::Source::Array do
  ...
  describe '#next' do
    def job(**attributes)
      Mutation::Parallel::Source::Job.new(attributes)
    end
    ...
    context 'when there is no next job' do
      ...
      it 'raises error' do
        expect { apply }.to raise_error(Mutation::Parallel::Source::NoJobError)
      end
    end
  end
