...
RSpec.describe Mutation::Parallel::Worker do
  describe '#call' do
    ...
    let(:running)      { 1                                         }
    let(:sink)         { instance_double(Mutation::Parallel::Sink)   }
    let(:source)       { instance_double(Mutation::Parallel::Source) }
