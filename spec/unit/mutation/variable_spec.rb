...
RSpec.describe Mutation::Variable::IVar do
  include MutationSpec::VariableHelper

  class_eval(&MutationSpec::VariableHelper.shared_setup)
  ...
  describe '#take_timeout' do
    ...
    context 'when ivar is initially full' do
      ...
      let(:expected_result) do
        Mutation::Variable.const_get(:Result)::Value.new(value)
      end
    ...
    context 'when ivar is initially empty' do
      ...
      context 'and timeout occurs before value is put' do
        let(:expected_result) do
          Mutation::Variable.const_get(:Result)::Timeout.new
        end
  ...
  describe '#put' do
    ...
    context 'when ivar is initially full' do
      ...
      it 'raises expected exception' do
        verify_events do
          expect { apply }.to raise_error(Mutation::Variable::IVar::Error, 'is immutable')
        end
      end
    end
  end
...
describe Mutation::Variable::MVar do
  include MutationSpec::VariableHelper
...
describe Mutation::Variable.const_get(:Result)::Value do
...
describe Mutation::Variable.const_get(:Result)::Timeout do
  describe '.new' do
