...
RSpec.describe Mutation::Subject::Method::Instance do
  let(:object)  { described_class.new(context, node) }

  let(:context) do
    Mutation::Context.new(
      scope,
  ...
  describe '#prepare' do
    ...
    let(:context) do
      Mutation::Context.new(scope, instance_double(Pathname))
    end
...
RSpec.describe Mutation::Subject::Method::Instance::Memoized do
  let(:object)  { described_class.new(context, node) }
  ...
  describe '#prepare' do
    ...
    let(:context) do
      Mutation::Context.new(scope, double('Source Path'))
    end
  ...
  describe '#mutations', mutation_expression: 'Mutation::Subject#mutations' do
    subject { object.mutations }

    let(:expected) do
      [
        ::Mutation::Mutation::Neutral.new(
          object,
          s(:begin,
