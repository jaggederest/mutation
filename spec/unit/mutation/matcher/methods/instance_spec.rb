...
RSpec.describe Mutation::Matcher::Methods::Instance, '#call' do
  ...
  let(:subject_c) { instance_double(Mutation::Subject) }
  ...
  before do
    {
      ...
      expect(Mutation::Matcher::Method::Instance).to receive(:new)
